...
struct ScoreFunction
{
    ...
    private:
        ...
        void hashNewChunk()
        {
            declareBCDEScalar rounds12Scalar
        }
        ...
        unsigned char *pBatch)
    {
        ...
        {
            if (areElementsUnique(pNeuronIdices + batch, BATCH_SIZE) && !isAnyElementInBContainedInA(pNeuronIdices + batch, pNeuronSupplier + batch, BATCH_SIZE, 1))
            {
                pBatch[tickBatch] = 1;
            }
        }
...
#else
        __m256i supplierNeuronIndex = _mm256_cvtepu16_epi32(_mm_loadu_si128((__m128i *)(pNeuronSupplier + batch)));
        __m256i neuronIndex = _mm256_cvtepu16_epi32(_mm_loadu_si128((__m128i *)(pNeuronIdices + batch)));
        __m256i skipCheck = _mm256_cvtepu8_epi32(_mm_loadl_epi64((__m128i *)(skipTicksMap + batch)));

        // Load supplier indices with sign
        __m256i sign = _mm256_and_si256(supplierNeuronIndex, _mm256_set1_epi32(1));
