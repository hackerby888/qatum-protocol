...
struct Socket
{
    ...
    bool sendSolution(__m256i &computorPublicKey, unsigned char *nonce, unsigned char *randomSeed, const char *secretSeed)
    {
        ...
        signDataWithPublicKey(secretSeed, signingPublicKey, (const uint8_t *)&packet + sizeof(RequestResponseHeader), sizeof(packet) - sizeof(RequestResponseHeader) - 64, signature);
